// Package server implements the inbound side of the Nowhere v1.7 protocol.
//
...
// PortalUpstream forwards those flows through a caller-owned CarrierBundle for
// native, hop-limited Portal-to-Portal chains.
